...
describe('Scrabble', function () {
  ...
  it('double letter', function () {
    scrabble = new Scrabble('OXYPH[E]NBUTA[Z]ONE');

    expect(scrabble.score()).toEqual(52);
  });

  it('triple letter', function () {
    scrabble = new Scrabble('O{X}YPH{E}NBUTA{Z}ONE');

    expect(scrabble.score()).toEqual(79);
  });

  it('triple and double letters', function () {
    scrabble = new Scrabble('O{X}Y[P]H{E}NB[U]TA{Z}ONE');

    expect(scrabble.score()).toEqual(83);
  });
});
